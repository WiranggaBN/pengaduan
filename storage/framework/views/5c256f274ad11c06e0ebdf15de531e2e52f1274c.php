...
<body>
  <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
    ...
    <div class="flex flex-col flex-1 w-full">
      ...
      <?php echo $__env->make('includes.masyarakat.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
  </div>
...
</html><?php /**PATH /opt/lampp/htdocs/PENGKAT-Pengaduan-Masyarakat/resources/views/layouts/masyarakat.blade.php ENDPATH**/ ?>