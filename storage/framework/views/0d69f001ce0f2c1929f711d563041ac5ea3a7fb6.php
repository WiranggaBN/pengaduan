<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
  <div class="container flex items-center justify-end h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
    ...
    <button class=" p-1 mr-5 -ml-1 rounded-md md:hidden focus:outline-none focus:shadow-outline-purple"
      ...
      <svg class="w-6 h-6" aria-hidden="true" fill=co"currentColor" viewBox="0 0 20 20">
...
</header><?php /**PATH /opt/lampp/htdocs/PENGKAT-Pengaduan-Masyarakat/resources/views/includes/admin/navbar.blade.php ENDPATH**/ ?>