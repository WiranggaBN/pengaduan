<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
  <div class="container flex items-center justify-end h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
    ...
    <div class="flex justify-center flex-1">
      ...
      <a class="inline-flex items-center text-sm mr-5 font-semibold transition-colors duration-150 "
        href="<?php echo e(url('user/pengaduan')); ?> ">
    ...
    <ul class="flex items-center flex-shrink-2 space-x-6">
      ...
      <li class="relative">
        <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none"
          ...
          <img class="object-cover w-8 h-8 rounded-full" src="https://ui-avatars.com/api/?background=fff&color=121317&name=<?php echo e(Auth::user()->name); ?>"
...
</header><?php /**PATH /opt/lampp/htdocs/PENGKAT-Pengaduan-Masyarakat/resources/views/includes/masyarakat/navbar.blade.php ENDPATH**/ ?>