    ...
    <div class="flex flex-wrap -mx-1 lg:-mx-4">
      ...
      <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
        ...
        <article class="overflow-hidden rounded-lg shadow-lg  text-gray-800">
          <img alt="Tulis"
            ...
            src="<?php echo e(asset('img/tulis.svg')); ?>" />
      ...
      <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
        ...
        <article class="overflow-hidden rounded-lg shadow-lg text-gray-800">
          <img alt="Proses"
            class="block h-auto w-full lg:w-28 mx-auto my-10 transform transition hover:scale-125 duration-300 ease-in-out"
            src="<?php echo e(asset('img/processing.svg')); ?>" />
          <header class="leading-tight p-2 md:p-4 text-center">
      ...
      <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
        ...
        <article class="overflow-hidden rounded-lg shadow-lg  text-gray-800">
          <img alt="Ditindak"
            class="block h-auto w-full lg:w-28 mx-auto my-10 transform transition hover:scale-125 duration-300 ease-in-out"
            src="<?php echo e(asset('img/act.svg')); ?>" />
          <header class="leading-tight p-2 md:p-4 text-center">
      ...
      <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
        ...
        <article class="overflow-hidden rounded-lg shadow-lg  text-gray-800">
          <img alt="Selesai"
            class="block h-auto w-full lg:w-28 mx-auto my-10 transform transition hover:scale-125 duration-300 ease-in-out"
            src="<?php echo e(asset('img/verification.svg')); ?>" />
          <header class="leading-tight p-2 md:p-4 text-center">
...
</html><?php /**PATH /opt/lampp/htdocs/PENGKAT-Pengaduan-Masyarakat/resources/views/welcome.blade.php ENDPATH**/ ?>